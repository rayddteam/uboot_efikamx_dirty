...
#gmake ARCH=arm CROSS_COMPILE=${CROSS} efikamx_config || exit 1
gmake ARCH=arm CROSS_COMPILE=${CROSS} USE_PRIVATE_LIBGCC=yes || exit 1

echo cp u-boot.bin /tftpboot/efika_mx/u-boot_efika_st.bin
cp u-boot.bin /tftpboot/efika_mx/u-boot_efika_st.bin
